...
const str: Record<string, Record<string, string>> = {
  en: { title: "Terms of Service", updated: "Last updated: April 4, 2026", intro: "By using Driftory, you agree to these terms. Please read them carefully.", s1: "1. Use of Service", s1d: "Driftory provides a travel aggregation platform. Users must be 18+ or have guardian consent. You are responsible for the accuracy of information you provide during booking.", s2: "2. Booking & Payments", s2d: "All bookings are subject to availability with our partner operators. Prices displayed are inclusive of applicable taxes unless stated. Payment processing is handled securely via Razorpay.", s3: "3. Liability", s3d: "Driftory acts as an intermediary between travelers and service providers. We are not liable for delays, cancellations, or service quality issues caused by third-party operators." },
